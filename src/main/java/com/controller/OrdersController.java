...
public class OrdersController {
    ...
    public R mchList(@RequestParam Map<String, Object> params,OrdersEntity orders,HttpServletRequest request){
        //设置查询条件
        EntityWrapper<OrdersEntity> ew = new EntityWrapper<OrdersEntity>();
        Wrapper<OrdersEntity> wrapper = MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, orders), params), params);
        wrapper.andNew().eq("userid",(Long) request.getSession().getAttribute("userId"));
        //查询结果
